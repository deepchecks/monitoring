...
import {
    regenerateApiTokenApiV1UsersRegenerateApiTokenGet
} from 'api/generated';
...
export function APIKey() {
    ...
    return (
        <Box>
            <Typography>
            The API key will allow you to insert, update, and access the data through the Deepchecks SDK. Please 
            refer to the documentation __here__
            </Typography>
