...
import { AlertRuleConfigSchema, useCreateAlertRuleApiV1MonitorsMonitorIdAlertRulesPost, useCreateMonitorApiV1ChecksCheckIdMonitorsPost, useGetAlertRuleApiV1AlertRulesAlertRuleIdGet, useGetMonitorApiV1MonitorsMonitorIdGet, useUpdateAlertApiV1AlertRulesAlertRuleIdPut, useUpdateMonitorApiV1MonitorsMonitorIdPut } from 'api/generated';
...
export const AlertRuleDialog = ({ alertRuleId = 0, onClose, ...props }: AlertRuleDialogProps) => {
    const { data: fetchedAlertRule, isLoading: isAlertRuleLoading } = useGetAlertRuleApiV1AlertRulesAlertRuleIdGet(alertRuleId);
    ...
    >
        ...
        <>
          ...
          <AlertRuleDialogContent handleComplete={handleComplete}/>
        </>
      }
    </Dialog>
    )
