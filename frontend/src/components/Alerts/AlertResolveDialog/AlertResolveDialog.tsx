...
// export function AlertResolveDialog({ resolve, ...props }: AlertResolveDialogProps) {
...
//       </StyledHeader>
//       <StyledTypographyMessage>
//         You are about to resolve <b>{alertRule?.alerts_count} active alerts</b> for all the system blah blah blah. are
