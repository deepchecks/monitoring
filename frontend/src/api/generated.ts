 ...
 */
export interface SingleWindowMonitorOptions {
...
>;
export type GetCheckWindowApiV1ChecksCheckIdRunWindowPostMutationBody = SingleWindowMonitorOptions;
...
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof getCheckWindowApiV1ChecksCheckIdRunWindowPost>>,
    TError,
    { checkId: number; data: SingleWindowMonitorOptions },
    TContext
  >;
}) => {
  const { mutation: mutationOptions } = options ?? {};
...
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof runCheckGroupByFeatureApiV1ChecksCheckIdGroupByModelVersionIdFeaturePost>>,
    TError,
    { checkId: number; modelVersionId: number; feature: string; data: SingleWindowMonitorOptions },
    TContext
  >;
}) => {
  const { mutation: mutationOptions } = options ?? {};
