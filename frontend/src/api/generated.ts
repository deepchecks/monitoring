...
/**
 * Monitor options for running check on a specific window.
 */
...
/**
 * class for selecting a specific amount of rows on a monitor data.
 */
...
/**
 * Basic monitor schema for running a check.
 */
...
export const getCheckWindowApiV1ChecksCheckIdRunWindowPost = (
  checkId: number,
  singleCheckWindowMonitorOptions: SingleCheckRunOptions
) =>
  customInstance<unknown>({
    url: `/api/v1/checks/${checkId}/run/window`,
    method: 'post',
    headers: { 'Content-Type': 'application/json' },
    data: singleCheckWindowMonitorOptions
  });
...
check_id : int
    ID of the check.
monitor_options : TableFiltersSchema
    The monitor options.
session : AsyncSession, optional
    SQLAlchemy session.
s3_bucket: str
...
export const getCheckReferenceApiV1ChecksCheckIdRunReferencePost = (
  checkId: number,
  checkMonitorOptions: CheckRunOptions
) =>
  customInstance<unknown>({
    url: `/api/v1/checks/${checkId}/run/reference`,
    method: 'post',
    headers: { 'Content-Type': 'application/json' },
    data: checkMonitorOptions
  });
...
>;
export type RunSuiteOnModelVersionApiV1ModelVersionsModelVersionIdSuiteRunPostMutationBody =
  SingleCheckRunOptions;
...
export const getModelVersionRefDataApiV1ModelVersionsModelVersionIdGetRefDataPost = (
  modelVersionId: number,
  monitorDataSchema: TableDataSchema
) =>
  customInstance<unknown>({
