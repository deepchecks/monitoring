describe('Alert Rules Screen', () => {
  ...
  function fillBasicDetails(details: BasicDetails, submit: boolean = true) {
    return (form: JQuery<HTMLElement>) => {
      cy.contains('button', 'Next').should('exist').as('basicDetailsSubmit');
  ...
  function fillMonitorData(monitorData: MonitorData, submit: boolean = true) {
    return (form: JQuery<HTMLElement>) => {
      cy.contains('button', 'Next').should('exist').as('monitorDataSubmit');

      cy.contains('button', 'Back').should('exist').as('monitorDataRollback');
  ...
  function fillAlertLogic(alertRuleLogic: AlertRuleLogic, submit: boolean = true) {
    return (form: JQuery<HTMLElement>) => {
      cy.contains('button', 'Save').should('exist').as('newAlertRuleSubmit');

      cy.contains('button', 'Back').should('exist').as('newAlertRuleRollback');
