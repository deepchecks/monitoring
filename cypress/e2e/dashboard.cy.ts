describe('test dashboard', () => {
  ...
  it('Add manual monitor - graphs appear', () => {
    ...
    cy.contains('div[role="presentation"]', 'Create monitor').contains('a', 'Advanced').click()
    ...
    cy.get('#menu-').contains('li', '1 day').click()
    cy.contains('div[role="presentation"]', 'Create monitor').contains('div', 'Display range').click()
