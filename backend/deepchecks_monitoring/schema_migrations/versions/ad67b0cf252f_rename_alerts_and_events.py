...
import deepchecks_monitoring.schema_models.pydantic_type
...
def upgrade() -> None:
    ...
    sa.Column('data_filters', deepchecks_monitoring.schema_models.pydantic_type.PydanticType(astext_type=Text()), nullable=True),
    sa.Column('condition', deepchecks_monitoring.schema_models.pydantic_type.PydanticType(astext_type=Text()), nullable=True),
