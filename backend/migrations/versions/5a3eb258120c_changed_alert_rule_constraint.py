...
def upgrade() -> None:
    ...
    op.drop_constraint('alert_rules_name_monitor_id_key1', 'alert_rules', type_='unique')
...
def downgrade() -> None:
    ...
    op.create_unique_constraint('alert_rules_name_monitor_id_key1', 'alert_rules', ['name', 'monitor_id'])
