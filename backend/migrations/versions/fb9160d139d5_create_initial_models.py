...
def upgrade() -> None:
    ...
    sa.Column('data_filter', deepchecks_monitoring.models.pydantic_type.PydanticType(astext_type=sa.Text()), nullable=True),
    sa.Column('alert_rule', deepchecks_monitoring.models.pydantic_type.PydanticType(astext_type=sa.Text()), nullable=True),
