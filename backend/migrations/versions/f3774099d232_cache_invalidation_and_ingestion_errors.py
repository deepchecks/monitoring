...
def upgrade() -> None:
    ...
    model_version_update = """
        ...
        monitor_json_schema = jsonb_set(monitor_json_schema, '{additionalProperties}', false),
        reference_json_schema = jsonb_set(reference_json_schema, '{additionalProperties}', false);
    """
